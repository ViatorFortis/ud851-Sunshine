    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                String weatherRequestUrlString = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);
                URL weatherRequestUrl = NetworkUtils.buildUrl(weatherRequestUrlString);

                try {
                    String weatherResults = NetworkUtils.getResponseFromHttpUrl(weatherRequestUrl);
                    return OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherResults);
                } catch (Exception e) {
                    e.printStackTrace();
                    return null;
                }
