...
//  TODO (1) Create a constant int value to identify the notification
    private static final int WEATHER_NOTIFICATION_ID = 235;
...
//          TODO (3) Create an Intent with the proper URI to start the DetailActivity
            Intent todaysDetailActivityIntent = new Intent(context, DetailActivity.class);
            todaysDetailActivityIntent.setData(todaysWeatherUri);

//          TODO (4) Use TaskStackBuilder to create the proper PendingIntent
            TaskStackBuilder taskStackBuilder = TaskStackBuilder.create(context);
            taskStackBuilder.addNextIntentWithParentStack(todaysDetailActivityIntent);
