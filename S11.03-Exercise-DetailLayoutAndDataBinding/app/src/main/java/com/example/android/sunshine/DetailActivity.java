...
//      TODO (7) Display the weather icon using mDetailBinding
        ...
        int weatherConditionImageId = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherConditionId);
        mDetailBinding.primaryInfo.weatherIcon.setImageResource(weatherConditionImageId);
...
//      TODO (15) Create the content description for the description for a11y
        String descriptionCD = getString(R.string.a11y_forecast, description);
...
//      TODO (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.primaryInfo.weatherDescription.setContentDescription(descriptionCD);

//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryInfo.weatherIcon.setContentDescription(descriptionCD);
...
//      TODO (17) Create the content description for the high temperature for a11y
        String highTemperatureCD = getString(R.string.a11y_high_temp, highString);
...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryInfo.highTemperature.setContentDescription(highTemperatureCD);
...
//      TODO (18) Create the content description for the low temperature for a11y
        String lowTemperatureCD = getString(R.string.a11y_low_temp, lowString);
...
//      TODO (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryInfo.lowTemperature.setContentDescription(lowTemperatureCD);
...
//      TODO (20) Create the content description for the humidity for a11y
        String humidityCD = getString(R.string.a11y_humidity, humidityString);
...
//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraDetails.humidityLabel.setContentDescription(humidityCD);
...
//      TODO (21) Create the content description for the wind for a11y
        String windCD = getString(R.string.a11y_wind, windString);
...
//      TODO (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraDetails.windMeasurement.setContentDescription(windCD);

//      TODO (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraDetails.windLabel.setContentDescription(windCD);
...
//      TODO (23) Create the content description for the pressure for a11y
        String pressureCD = getString(R.string.a11y_pressure, pressureString);
...
//      TODO (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraDetails.pressureLabel.setContentDescription(pressureCD);
